...
# pd.read_json(celltype_sample_obs_json, orient='split')

# COMMAND ----------

# DBTITLE 1,cell_subsample
## preserve the index from original data | celltype_subsample : "subsample_query_array" (tutorial_ver)
...
# celltype_subsample_pdf.to_json(orient='split')
...
# model_input = pd.DataFrame([{"celltype_sample": celltype_subsample_pdf.to_json(orient='split'), 
#                              "celltype_sample_obs": celltype_sample.obs.to_json(orient='split')
#                             }
#                           ])
...
# pd.concat([celltype_subsample_pdf, celltype_sample.obs], axis=1)
...
# https://adb-830292400663869.9.azuredatabricks.net/ml/experiments/332441420736406/runs/776b0d12bdb04a30b801258f850bea9a/artifacts?o=830292400663869
