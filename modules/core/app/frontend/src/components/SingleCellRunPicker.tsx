  ...
  if (completed.length === 0) {
    return (
      <div className="rounded-md border border-border bg-muted/30 p-3 text-sm text-muted-foreground">
        No completed single-cell processing runs found for your account. Once the Raw Single
        Cell Processing tab is available, runs you complete there will appear here.
      </div>
    )
  }
