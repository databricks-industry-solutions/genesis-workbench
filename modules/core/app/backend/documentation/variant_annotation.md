...
2. **Backend** (`modules/core/app/backend/app/services/genomics.py`): `start_variant_annotation()` creates MLflow run and triggers job
...
- `modules/core/app/backend/app/services/genomics.py` — `start_variant_annotation()`, `pull_annotation_results()`
