...
2. **Backend** (`modules/core/app/backend/app/services/genomics.py`): `start_gwas_analysis()` creates MLflow run and triggers job
...
- `modules/core/app/backend/app/services/genomics.py` — `start_gwas_analysis()`, `pull_gwas_results()`
