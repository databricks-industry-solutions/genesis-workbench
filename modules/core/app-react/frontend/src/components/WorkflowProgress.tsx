...
/**
 * Streamlit-style staged progress indicator for synchronous workflows.
 * Time-based: advances through the listed stages on a clock, not from real
 * server-side events. Matches what the Streamlit `progress_callback`
 * actually did (stage transitions only), with a determinate bar so the user
 * gets visible motion during waits.
 */
