...
# The Streamlit `_render_run_header` shows this curated set first; mirror it
...
def run_dotplot(payload: DotplotRequest, _: CurrentUserDep) -> DotplotResponse:
    ...
    if payload.selected_genes:
        ...
        # Top N genes per cluster by z-score (matches Streamlit fallback)
...
def run_de(payload: DERequest, _: CurrentUserDep) -> DEResponse:
    ...
    # Benjamini-Hochberg-ish adjustment matching the Streamlit pattern
...
def run_enrichment(payload: EnrichmentRequest, _: CurrentUserDep) -> EnrichmentResponse:
    ...
    try:
        ...
        # Streamlit pipeline. Top-by-mean-expression (the old approach) was
        ...
        try:
            ...
            if cl_str in markers_mapping.columns:
                ...
                # direct match — same convention as the Streamlit code.
