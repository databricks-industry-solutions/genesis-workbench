...
WORKFLOWS = [
    ...
    ("variant_annotation", "Variant Annotation", "databricks_job", "genomics",
     ...
     [{"name": "gene_panel_mode", "type": "select", "options": ["custom", "acmg"]},
      ...
      {"name": "pathogenic_vcf_path", "type": "string"}],
    ...
    ("gwas", "GWAS", "databricks_job", "genomics", "gwas_glow_analysis",
     ...
     [{"name": "phenotype_column", "type": "string"}, {"name": "contigs", "type": "string"},
      {"name": "hwe_cutoff", "type": "string"}, {"name": "pvalue_threshold", "type": "string"}],
    ...
    ("molecule_optimization", "Guided Molecule Optimization", "databricks_job", "small_molecule",
     ...
     [{"name": "num_iterations", "type": "int"}, {"name": "num_samples", "type": "int"},
      {"name": "select_top", "type": "int"}, {"name": "dock_top_k", "type": "int"},
      {"name": "qed_min", "type": "float"}, {"name": "tox_max", "type": "float"},
      {"name": "temperature", "type": "float"}, {"name": "randomness", "type": "float"},
      {"name": "target_label", "type": "string"}, {"name": "dock_per_iter", "type": "int"},
      {"name": "dock_samples", "type": "int"}],
    ...
    ("esm2_finetune", "Fine-Tune ESM2", "databricks_job", "large_molecule",
     ...
     [{"name": "train_data", "dtype": "path"}, {"name": "evaluation_data", "dtype": "path"}],
     [{"name": "weights", "dtype": "path"}],
     [{"name": "finetune_label", "type": "string"},
      {"name": "esm_variant", "type": "select", "options": ["8M", "35M", "150M", "650M"]},
      {"name": "task_type", "type": "select", "options": ["regression", "classification"]},
      {"name": "num_steps", "type": "int"}, {"name": "should_use_lora", "type": "bool"},
      {"name": "micro_batch_size", "type": "int"}, {"name": "precision", "type": "string"},
      {"name": "mlp_ft_dropout", "type": "float"}, {"name": "mlp_hidden_size", "type": "int"},
      {"name": "mlp_target_size", "type": "int"}, {"name": "mlp_lr", "type": "float"},
      {"name": "mlp_lr_multiplier", "type": "float"}],
    ...
    ("kermt_finetune", "Fine-Tune KERMT", "databricks_job", "small_molecule",
     ...
     [{"name": "finetune_label", "type": "string"}, {"name": "target_names", "type": "string"},
      {"name": "dataset_type", "type": "select", "options": ["classification", "regression"]},
      {"name": "epochs", "type": "int"}, {"name": "batch_size", "type": "int"},
      {"name": "ffn_hidden_size", "type": "int"}],
    ...
    ("kermt_deploy", "Deploy KERMT", "databricks_job", "small_molecule",
     ...
     [{"name": "model_name", "type": "string"}, {"name": "workload_type", "type": "string"}],
    ...
    ("admet_screen", "ADMET Screen", "endpoint_chain", "small_molecule", None,
     ...
     [{"name": "run_admet", "type": "bool"}, {"name": "run_bbbp", "type": "bool"},
      {"name": "run_clintox", "type": "bool"}, {"name": "run_kermt", "type": "bool"}],
     "Chain: run selected ADMET / toxicity predictors over a SMILES set."),
