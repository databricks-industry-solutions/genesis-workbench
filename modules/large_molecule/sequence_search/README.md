...
┌──────────────────────────────────────────────────────────────────┐
│  User pastes amino acid sequence in the                │
│       ↓                                                          │
...
(default 50) are returned to thewith full alignment details.
...
- ESM2 Embeddings model must be deployed first
  (`modules/large_molecule/esm2_embeddings/`)
- Core module must be deployed (provides libraries volume, workbench tables)

### Deploy

```bash
cd modules/large_molecule/sequence_search/sequence_search_v1
