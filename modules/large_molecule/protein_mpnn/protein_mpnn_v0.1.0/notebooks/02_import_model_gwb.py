...
model_uc_name=f"{catalog}.{schema}.proteinmpnn"
...
gwb_model_id = import_model_from_uc(user_email=user_email,
                    ...
                    model_display_name="ProteinMPNN",
                    model_source_version="v1.0.1",
                    model_description_url="https://github.com/dauparas/ProteinMPNN.git")

# COMMAND ----------

run_id = deploy_model(user_email=user_email,
                gwb_model_id=gwb_model_id,
                deployment_name=f"Protein_MPNN",
                deployment_description="ProteinMPNN v0.1.0 inverse-folding / sequence design model (MIT). Given a target protein backbone (PDB), returns amino-acid sequences predicted to fold to that structure. Standard companion to RFdiffusion for de-novo design.",
