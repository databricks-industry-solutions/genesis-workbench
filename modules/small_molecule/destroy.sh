...
ALL_SUBMODULES=(chemprop/chemprop_v2 diffdock/diffdock_v1 proteina_complexa/proteina_complexa_v1 netsolp/netsolp_v1 pltnum/pltnum_v1 deepstabp/deepstabp_v1 mhcflurry/mhcflurry_v2)
