...
if artifact_info:
    ...
    try:
        local_path = mlflow.artifacts.download_artifacts(
            artifact_uri=f"models:/{uc_name}/{uc_version}/{artifact_path}")
    except Exception:
        pass
    ...
    if local_path is None:
        print("Could not download input_example. Skipping warm-up.")
        dbutils.notebook.exit("Failed to download input_example for warm-up")
