...
query = f"""
    ...
    USING (SELECT 'vcf_ingestion_job_id' AS key, '{vcf_ingestion_job_id}' AS value, 'genomics' AS module) AS source
...
print("Genomics VCF Ingestion module initialization complete")
