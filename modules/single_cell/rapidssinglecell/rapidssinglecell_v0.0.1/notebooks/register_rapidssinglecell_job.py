...
catalog = dbutils.widgets.get("core_catalog")
schema = dbutils.widgets.get("core_schema")
run_rapidssinglecell_job_id = dbutils.widgets.get("run_rapidssinglecell_job_id")
...
WHERE key = 'run_rapidssinglecell_job_id' AND module = 'single_cell'
""")

# Insert the job ID
spark.sql(f"""
INSERT INTO settings VALUES
('run_rapidssinglecell_job_id', '{run_rapidssinglecell_job_id}', 'single_cell')
""")
