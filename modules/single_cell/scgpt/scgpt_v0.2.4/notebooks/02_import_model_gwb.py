...
run_id = deploy_model(user_email=user_email,
                ...
                deployment_description="scGPT v0.2.4 single-cell foundation transformer (MIT). Pre-trained on >33M cells; returns cell-level embeddings from raw or pre-processed expression matrices for cell-type annotation, cell similarity, and perturbation prediction downstream.",
